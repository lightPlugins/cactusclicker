package io.lightplugins.cactusclicker;

import com.zaxxer.hikari.HikariDataSource;
import io.lightplugins.cactusclicker.eco.LightEco;
import io.lightplugins.cactusclicker.util.ColorTranslation;
import io.lightplugins.cactusclicker.util.DebugPrinting;
import io.lightplugins.cactusclicker.util.MessageSender;
import io.lightplugins.cactusclicker.util.SubPlaceholder;
import io.lightplugins.cactusclicker.util.database.SQLDatabase;
import io.lightplugins.cactusclicker.util.database.impl.MySQLDatabase;
import io.lightplugins.cactusclicker.util.database.impl.SQLiteDatabase;
import io.lightplugins.cactusclicker.util.database.model.ConnectionProperties;
import io.lightplugins.cactusclicker.util.database.model.DatabaseCredentials;
...
import io.lightplugins.cactusclicker.util.manager.MultiFileManager;
import io.lightplugins.cactusclicker.util.manager.PlaceholderManager;
...
public class Light extends JavaPlugin {
    ...
    public final static String consolePrefix = "§r[cactus§eClickery§r] §r";
    ...
    public void onLoad() {
        ...
        if(!this.initDatabase()) {
            ...
            getDebugPrinting().print("§4CactusClicker is shutting down... ");
    ...
    public void onEnable() {
        ...
        debugPrinting.print("Loading CactusClicker modules...");
